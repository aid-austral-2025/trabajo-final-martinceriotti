...
datos |> 
  ...
  summarise(superficie_sembrada_ha_total = sum(superficie_sembrada_ha)) |> 
    ggplot() +
      ...
      labs(x = 'Año', y = 'Superficie Sembrada en millones de ha.', color = "Cultivos", title = "Gráfico 1: Evolución de la superficie sembrada.", subtitle = "En millones de hectárea") 
...
**2008**: Comienzo del conflicto entre el gobierno nacional y los productores.

En el gráfico 1 se puede apreciar el crecimiento exponencial a partir del año 1970 cuando se comienza a usar la siembra directa (se siembra directamente sobre el rastrojo del cultivo anterior, sin labrar el suelo previamente).

En 2008 ese crecimiento se detiene. El conflicto del campo fue una profunda disputa entre el gobierno nacional y el sector agropecuario, originada por la Resolución 125/2008, que establecía un sistema de retenciones móviles a las exportaciones de granos, especialmente soja.
